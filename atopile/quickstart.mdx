...
<Warning>
    Windows isn't yet natively supported. You can install atopile via WSL or Docker using ubuntu 24.04.
</Warning>

See the [installation guide](guides/installation) for more details.
...
If you are on macOS, and you have `brew` installed, you can install KiCAD with:
