...
Traits in ato are a way to extend the functionality of a module.

Currently the following traits are supported:

## can_bridge_by_name

This trait enables using the [sperm operator `~>`](./1-the-ato-language.mdx) to make a "bridging" connection over a module.
