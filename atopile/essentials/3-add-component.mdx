...
description: 'There are 4 ways to add components to a project.'
icon: 'plus'
---
...
The [atopile package registry](https://packages.atopile.io) contains many pre-made [packages](./4-packages) for common components. For example, if you need an STM32 microcontroller, you can install the package:
