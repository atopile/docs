...
<ParamField path="doping_type" type="string">
</ParamField>

<ParamField path="operation_region" type="string">
</ParamField>


## Interfaces

<ParamField path="emitter" type="Electrical">
</ParamField>

<ParamField path="base" type="Electrical">
</ParamField>

<ParamField path="collector" type="Electrical">
</ParamField>
