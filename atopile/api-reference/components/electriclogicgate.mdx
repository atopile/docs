...
<ParamField path='inputs[0]' type='ElectricLogic'>
</ParamField>

<ParamField path='inputs[1]' type='ElectricLogic'>
</ParamField>

<ParamField path='outputs[0]' type='ElectricLogic'>
</ParamField>

<ParamField path='outputs[1]' type='ElectricLogic'>
</ParamField>
