...
<ParamField path='equivalent_series_resistance' type='Ω'>
</ParamField>

<ParamField path='shunt_capacitance' type='F'>
</ParamField>

<ParamField path='load_capacitance' type='F'>
</ParamField>
...
<ParamField path='footprint' type='string'>
</ParamField>
