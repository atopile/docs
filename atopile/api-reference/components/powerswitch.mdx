...
title: "PowerSwitch"
icon: microchip
description: "A generic module that switches power based on a logic signal, needs specialization
...
<ParamField path='logic_in' type='string'>
</ParamField>

<ParamField path='power_in' type='string'>
</ParamField>

<ParamField path='switched_power_out' type='string'>
</ParamField>
