...
<ParamField path="dc_breakdown_voltage" type="V">
</ParamField>

<ParamField path="impulse_discharge_current" type="A">
</ParamField>


## Interfaces

<ParamField path="common" type="Electrical">
</ParamField>

<ParamField path="tube_1" type="Electrical">
</ParamField>

<ParamField path="tube_2" type="Electrical">
</ParamField>
