...
<Tip>
Just want to try atopile without installing anything? Check out the [playground](https://atopile-playground.fly.dev/) — it runs entirely in your browser.
...
Once you have a VS Code editor, search for the extension or install by clicking [atopile extension](vscode:extension/atopile.atopile).
